...
const copy = {
  en: {
    ...
    homeSubtitle: "We found 14 profiles matching your preferences today.",
    meaningfulConnections: "Take your time. Meaningful connections have no shortcuts.",
  ...
  kn: {
    ...
    kannada: "ಕನ್ನಡ",
    goodMorning: "ಶುಭೋದಯ, ಅನನ್ಯಾ",
    homeSubtitle: "ನಿಮ್ಮ ಆದ್ಯತೆಗಳಿಗೆ ಹೊಂದುವ 14 ಪ್ರೊಫೈಲ್‌ಗಳನ್ನು ಕಂಡುಕೊಂಡಿದ್ದೇವೆ.",
    meaningfulConnections: "ನಿಧಾನವಾಗಿ ಮುಂದುವರಿಯಿರಿ. ಅರ್ಥಪೂರ್ಣ ಸಂಬಂಧಗಳಿಗೆ ಆತುರವಿಲ್ಲ.",
